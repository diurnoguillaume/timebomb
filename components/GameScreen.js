window.GameScreen = function ({
  ...
  const Scissors = lucide.Scissors;
        ...
        <div className="bg-slate-800 rounded-xl p-4 mb-4 border border-slate-700">
          <div className="flex flex-wrap gap-4 justify-between items-center">
            ...
            <div className="text-white text-right">
              ...
              {isMyTurn && (
                <div className="text-sm text-yellow-400">Your turn!</div>
              )}
            </div>
          </div>
          ...
          >
            <p className="text-white text-sm">
              {myRole === "sherlock" ? (
                <>
                  🎯 Find all {gameState.config.defusing} Defusing wires to win.
                  Avoid the Bomb!
                </>
              ) : (
        ...
        <div className="mt-6 bg-slate-800 rounded-xl p-4 border border-slate-700 mb-20">
          ...
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-slate-600 rounded flex items-center justify-center text-slate-400">
                ✓
              </div>
