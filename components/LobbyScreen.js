        ...
        {isHost && (
          <div className="mb-6">
            <label className="block text-white mb-3 font-semibold">
              {React.createElement(Users, { className: "inline w-5 h-5 mr-2" })}
              Number of Players
            </label>
            ...
            <div className="bg-slate-900 rounded-lg p-3 mt-3 text-sm text-slate-300">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-blue-400">
                  {window.GAME_CONFIG[gameState.playerCount].sherlock}
                </span>
              </div>
              <div className="flex justify-between mt-1">
                ...
                <span className="font-bold text-red-400">
                  {window.GAME_CONFIG[gameState.playerCount].moriarty}
                </span>
              </div>
            </div>
          </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {player.id === gameState.hostId && (
                    <span className="text-xs bg-yellow-500 text-slate-900 px-2 py-1 rounded font-bold">
                      HOST
                    </span>
                  )}
                  {player.id === playerId && (
