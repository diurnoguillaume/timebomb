      ...
      <div className="bg-slate-800 rounded-2xl shadow-2xl p-8 max-w-md w-full border border-slate-700 text-center">
        <div className="mb-6">
          {gameState.winner === "sherlock"
            ? React.createElement(Shield, {
                className: "w-20 h-20 mx-auto text-blue-400 mb-4 animate-pulse",
              })
            : React.createElement(Zap, {
                className: "w-20 h-20 mx-auto text-red-400 mb-4 animate-pulse",
              })}
        </div>
        ...
        <div className="bg-slate-900 rounded-lg p-4 mb-6">
          ...
          <p className="text-slate-400 mt-2">
            You were on {myRole === "sherlock" ? "Sherlock's" : "Moriarty's"}{" "}
            team
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-slate-900 rounded-lg p-4 text-left">
            ...
            {gameState.players.map((p) => (
              <div key={p.id} className="flex justify-between text-sm py-1">
                ...
                <span
                  className={
                    p.role === "sherlock" ? "text-blue-400" : "text-red-400"
                  }
                >
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              } bg-gradient-to-r from-blue-600 to-blue-500 text-white py-4 rounded-lg font-bold hover:from-blue-700 hover:to-blue-600 transition-all`}
            >
              Leave Room
            </button>
          </div>
